    ...
    return (
        <NavigationContainer>
            <Stack.Navigator
                ...
                <Stack.Screen name="Login" component={LoginPage} options={{ title: 'WhiteBoard', headerShown: false }} />
                <Stack.Screen name="Camera" component={CameraPage} options={{ title: 'WhiteBoard', headerShown: false }} />
